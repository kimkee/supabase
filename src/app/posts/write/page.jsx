        ...
        <div className="board-write">
          <ul className="list">
            ...
            <li>
              ...
              <div className="dd">
                <label className="radio"><input type="radio" name="radio1" /><span className="txt">새상품</span></label>
                <label className="radio"><input type="radio" name="radio1" /><span className="txt">단순개봉</span></label>
                <label className="radio"><input type="radio" name="radio1" /><span className="txt">중고</span></label>
              </div>
            </li>
            <li>
